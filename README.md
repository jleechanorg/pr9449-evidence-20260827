...
`5de277d3eabbbcc08a031f35ad8408c6b3371f92`.

The two complementary bundles prove distinct boundaries:

- [Real-server disconnect bundle](artifacts/pr9449-5de277d3-disconnect-evidence.zip):
...
- [Gemini SDK deadline bundle](artifacts/pr9449-5de277d3-provider-evidence.zip):
...
The older `f0e614a` and `04a08dd9` files remain archived for historical
comparison and are not the current acceptance evidence.
